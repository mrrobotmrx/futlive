...
exports.getapv = async () => {
    ...
    const res = await Product
        .find({
            active: false
        }, 'title image email').sort(mysort).limit(12);
    ...
    await Product
        .findByIdAndUpdate(id, {
            $set: {
                ...
                competicaoPhoto: data.competicaoPhoto,
                hrPartida: data.hrPartida,
                placar: data.placar,
                modoJogo: data.modoJogo,
                photoTim1: data.photoTim1,
                photoTim2: data.photoTim2,
                nameTim1: data.nameTim1,
                nameTim2: data.nameTim2,
